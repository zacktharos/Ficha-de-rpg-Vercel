...
export const DiceRoller: React.FC<DiceRollerProps> = ({ onRoll, selectedAttribute, ficha, positionClass = "fixed bottom-5 right-5 z-40", buttonClass, isDraggable = false }) => {
    ...
    const handleRoll = (max: number) => {
        ...
        // Auto-close the animation modal
        setTimeout(() => {
                        ...
                        {lastRoll === null && (
                            <div className="dice-cube-container">
                                <div ref={cubeRef} id="dice-cube" className="dice-cube">
                                    <div className="dice-face face-front" style={diceStyle}>1</div>
                                    <div className="dice-face face-back" style={diceStyle}>6</div>
                                    <div className="dice-face face-top" style={diceStyle}>5</div>
                                    <div className="dice-face face-bottom" style={diceStyle}>2</div>
                                    <div className="dice-face face-left" style={diceStyle}>4</div>
                                    <div className="dice-face face-right" style={diceStyle}>3</div>
                                </div>
                            </div>
                        )}
                    </div>
